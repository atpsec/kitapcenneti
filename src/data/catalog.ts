...
export function buildCatalog(): CatalogItem[] {
  ...
  for (const s of AUDIO_STORIES) {
    items.push({
      ...
      tags: [s.theme, s.age, 'Geschichte', 'Audio'],
      age: s.age,
      page: 'audio',
      sourceId: s.id,

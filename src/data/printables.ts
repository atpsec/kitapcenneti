...
export const PRINTABLES: Printable[] = [
  ...
  { id: 'stem', title: 'MINT-Experimentkarte', emoji: '🔬', age: '4+', category: 'Wissenschaft', link: 'stem', description: 'Mini-Experiment mit Haushaltsmaterialien', premium: true },
  ...
  { id: 'aile', title: 'Familienführer', emoji: '👨‍👩‍👧', age: 'Eltern', category: 'Familie', link: 'blog', description: 'Eltern-Blogbeiträge', premium: true },
  ...
  { id: 'yol-haritasi', title: 'Lernpfad', emoji: '🛤️', age: '6+', category: 'Bildung', link: 'paths', description: 'Schritt-für-Schritt-Kompetenzplan' },
  { id: 'ogretmen', title: 'Unterrichtsaktivität', emoji: '🍎', age: 'Lehrkräfte', category: 'Bildung', link: 'teachers', description: 'Ideen für den Einsatz im Unterricht', premium: true },
  ...
  { id: 'aile-sozlesme', title: 'Familienvereinbarung', emoji: '🤝', age: 'Eltern', category: 'Familie', link: 'parents', description: 'Regeln gemeinsam festhalten und unterschreiben' },
  ...
  { id: 'haftalik-menu', title: 'Wöchentlicher Menüplan', emoji: '📋', age: 'Eltern', category: 'Planung', link: 'calendar', description: 'Wöchentlicher Menüplan – druckbare PDF-Idee' },
  { id: 'roket-kes', title: 'Rakete ausschneiden und einfügen', emoji: '🚀', age: '5+', category: 'Kunst', link: 'coloring', description: 'Ausschneiden und Einfügen einer Rakete – druckbare PDF-Idee' },
  ...
  { id: 'ogretmen-plan', title: 'Unterrichtsplan für Lehrkräfte', emoji: '👩‍🏫', age: 'Lehrkräfte', category: 'Bildung', link: 'teachers', description: 'Unterrichtsplan für Lehrkräfte – druckbare PDF-Idee' },
  { id: 'kesfet-liste', title: 'Checkliste für die Entdeckung', emoji: '🧭', age: '5+', category: 'Entdeckung', link: 'discover', description: 'Entdeckungs-Checkliste – druckbare PDF-Idee' },
